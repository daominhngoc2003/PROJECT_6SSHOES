    ...
    <div className="h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800">
      <ul className="space-y-2  text-gray-800 px-4">
        ...
        <li className="group">
          <Link
            to="/admin/dashboard"
            className={`flex items-center p-2 rounded-lg transition-all dark:text-white  dark:hover:bg-gray-700 group ${currentPage === "/admin/dashboard" ? "text-[#2c7be5]" : "group-hover:text-gray-800"}`}
          >
            <MdDashboard />
